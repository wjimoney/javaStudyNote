...
```sh
sed -i -e 's/6379/7001/g' -e 's/dir .\//dir \/tmp/redis\/7001\//g' 7001/redis.conf
...
```sh
# 逐一执行
sed -i '1a replica-announce-ip 192.168.115.131' 7001/redis.conf
...
```sh
# 第1个
redis-sentinel s27001/sentinel.conf
# 第2个
redis-sentinel s27002/sentinel.conf
# 第3个
redis-sentinel s27003/sentinel.conf
```
...
# 创建集群
./redis-trib.rb create --replicas 1 192.168.115.131:7001 192.168.115.131:7002 192.168.115.131:7003 192.168.115.131:8001 192.168.115.131:8002 192.168.115.131:8003
```
...
```sh
redis-cli --cluster create --cluster-replicas 1 192.168.115.131:7001 192.168.115.131:7002 192.168.115.131:7003 192.168.115.131:8001 192.168.115.131:8002 192.168.115.131:8003
```
